...
Name things for what they are. Not "risk-adjusted returns" but "you might lose most of it." \
Not "limited access" but "waitlist, no public timeline." Not "automated income" but "a system that \
...
Middle tweets (1 to 2 max): the facts that matter, stated plainly. No mechanics. No disclaimers.
